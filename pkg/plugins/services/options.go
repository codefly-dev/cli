...
//	switch any(t).(type) {
//	case *corev1.Choice:
//		choice, ok := any(opt.Default).(*corev1.Choice)
//		if !ok {
...
//}
//
//func (p *Prompt) With(opts ...*corev1.Option) error {
...
//}
//
//func NewRuntimeOption[T any](name string, description string, value T) *corev1.Option {
//	return &corev1.Option{
//		Name:        name,
...
//*/
//
//func NewRuntimeOptionDefault[T any](value T) *corev1.OptionDefault {
//	switch v := any(value).(type) {
//	case string:
//		return &corev1.OptionDefault{Value: &corev1.OptionDefault_StrValue{StrValue: v}}
//	case float32:
//		return &corev1.OptionDefault{Value: &corev1.OptionDefault_FloatValue{FloatValue: v}}
//	case bool:
//		return &corev1.OptionDefault{Value: &corev1.OptionDefault_BoolValue{BoolValue: v}}
//	case int:
//		return &corev1.OptionDefault{Value: &corev1.OptionDefault_IntValue{IntValue: int64(v)}}
//	case *corev1.Choice:
//		return &corev1.OptionDefault{Value: &corev1.OptionDefault_ChoiceValue{ChoiceValue: v}}
//	default:
//		return nil
//	}
//}
//
//func ConvertToOption(opt *corev1.Option) (interface{}, error) {
//	logger := shared.NewLogger("plugins.ConvertToOption")
