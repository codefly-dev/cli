...
func TestConfigurationBindingRejectsAnEffectiveIdentityOverride(t *testing.T) {
	...
	require.ErrorContains(t, projectServiceConfiguration(t.Context(), root, &resources.Service{Name: "api"}, env, scopeOf(env), serviceInjection{}), "bind no effective workload")
}
