...
type FactoryClient interface {
	...
	Communicate(ctx context.Context, in *core.Engage, opts ...grpc.CallOption) (*core.InformationRequest, error)
}
...
func (c *factoryClient) Communicate(ctx context.Context, in *core.Engage, opts ...grpc.CallOption) (*core.InformationRequest, error) {
	out := new(core.InformationRequest)
...
type FactoryServer interface {
	...
	// Communication helper
	Communicate(context.Context, *core.Engage) (*core.InformationRequest, error)
...
func (UnimplementedFactoryServer) Communicate(context.Context, *core.Engage) (*core.InformationRequest, error) {
...
func _Factory_Communicate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FactoryServer).Communicate(ctx, req.(*core.Engage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Factory_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/factory/factory.proto",
}
