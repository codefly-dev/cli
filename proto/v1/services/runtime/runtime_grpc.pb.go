...
func (c *runtimeClient) Communicate(ctx context.Context, in *core.Engage, opts ...grpc.CallOption) (*core.InformationRequest, error) {
...
func (UnimplementedRuntimeServer) Communicate(context.Context, *core.Engage) (*core.InformationRequest, error) {
...
func _Runtime_Communicate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuntimeServer).Communicate(ctx, req.(*core.Engage))
	}
	return interceptor(ctx, in, info, handler)
}
