...
const (
	Provider_Init_FullMethodName = "/v1.provider.Provider/Init"
)
...
func (c *providerClient) Init(ctx context.Context, in *InitRequest, opts ...grpc.CallOption) (*InitResponse, error) {
	...
	err := c.cc.Invoke(ctx, Provider_Init_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Provider_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.provider.Provider",
	...
	Metadata: "providers/provider.proto",
}
