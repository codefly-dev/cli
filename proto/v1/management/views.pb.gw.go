...
func RegisterWebHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WebServer) error {
	...
	mux.Handle("GET", pattern_Web_GetProjectInformation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.applications.views.Web/GetProjectInformation", runtime.WithHTTPPathPattern("/project/information"))
		if err != nil {
...
func RegisterWebHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WebClient) error {
	...
	mux.Handle("GET", pattern_Web_GetProjectInformation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.applications.views.Web/GetProjectInformation", runtime.WithHTTPPathPattern("/project/information"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
